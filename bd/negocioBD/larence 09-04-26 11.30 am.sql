...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2026 a las 17:28:52
...
(32200771, 'J', 3, 'Mi Super', 'Cale 54 con Carrera 20', '02514408820', 'misuper@gmail.com', 'Activo', 'assets/img/clientes/miSuper.png', 1),
...
(1, 'Harina de Trigo', 'Harina de trigo para la elaboracion de galletas secas y polvorosas', 1, 90, 171009980, 1),
(2, 'Huevos', 'Elaboracion de galletas a base de huevo', 8, 55, 310397110, 1),
...
(2, 'Galletas Kaiadmin dulces con sabor a Naranja 90g cont', 1.50, 10, '2026-04-02', '2026-04-30', 2, 'assets/img/productos/img6.png', 1),
(3, 'Galletas dulces Kaiadmin con sabor a coco 90g cont', 3.50, 50, '2026-04-02', '2026-05-30', 1, 'assets/img/productos/img1.png', 1),
(4, 'Gatelltas Kaiadmin Chocoking 40g cont', 2.50, 45, '2026-04-02', '2026-05-30', 1, 'assets/img/productos/img2.png', 1),
(5, 'Galletas Kaiadmin Saladitas queso chedar 90g cont', 2.00, 25, '2026-04-02', '2026-05-30', 1, 'assets/img/productos/img3.png', 1),
(6, 'Gatellas Kaiadmin Polvosas con sabor a vainilla 90g cont', 2.50, 28, '2026-04-03', '2026-05-30', 1, 'assets/img/productos/img3.png', 1),
(7, 'Galletas Kaiadmin dulces con sabor a Limon 90g cont', 1.50, 60, '2026-04-03', '2026-05-30', 1, 'assets/img/productos/img5.png', 1),
(8, 'Galletas Kaiadmin dulces con sabor a Colita 90g cont', 2.50, 5, '2026-04-03', '2026-05-30', 1, 'assets/img/productos/img4.png', 1);
...
--
ALTER TABLE `detalle_promocion`
  MODIFY `id_detalle_promocion` int(11) NOT NULL AUTO_INCREMENT;
