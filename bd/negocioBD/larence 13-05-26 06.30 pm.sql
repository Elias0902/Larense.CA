...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-05-2026 a las 00:12:33
...
(2, 'Galletas Natys dulces con sabor a Naranja 90g cont', 1.50, 19, '2026-04-02', '2026-04-30', 2, 'assets/img/productos/img6.png', 1),
...
(3, 'Galletas sabor vainilla y limon 10% de descuentos', 'En todas las Galletas con sabor a vainilla y limon tendran un  descuento del 10%', '2026-05-04', '2026-05-07', 'porcentaje', 10.00, 1, 1),
...
(5, 'Galletas sabor a colita 50% de descuentos', 'L Galleta sabor a colita tendra un descuento de hasta el 50%', '2026-05-05', '2026-05-08', 'porcentaje', 49.99, 1, 1);
...
--
ALTER TABLE `cuenta_x_cobrar`
  MODIFY `id_cuenta_x_cobrar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `detalle_pedidos`
  MODIFY `id_detalle_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
