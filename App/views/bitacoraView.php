...
<html lang="en">
  <head>
    ...
    <style>
        /* Estilos modo oscuro para bitácora */
        body.dark-mode {
        ...
        body[data-background-color="dark"] .card-header h4 {
            color: #e7e9f0 !important;
        }
        ...
        body[data-background-color="dark"] .table tbody td {
            color: #e7e9f0 !important;
            border-bottom-color: #2a3041 !important;
        }
        ...
        body[data-background-color="dark"] .badge {
            background: #2a3041 !important;
            color: #e7e9f0 !important;
        }
        ...
        body[data-background-color="dark"] .form-label {
            color: #e7e9f0 !important;
        }
