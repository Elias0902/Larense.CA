              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  ...
                  >
                    ...
                    <tbody>
                          <?php
                if(isset($cuentasCobrar) && is_array($cuentasCobrar) && !empty($cuentasCobrar)){
                foreach ($cuentasCobrar as $cuenta):
                    ...
                    switch($cuenta['estado_cuenta']) {
                        ...
                        default:
                            $estado_class = 'badge-secondary';
                            $estado_texto = ucfirst($cuenta['estado_cuenta']);
                    }
                          ...
                          <tr style="transition: all 0.2s;">
                            <td style="padding: 15px; vertical-align: middle; font-weight: 500;">
                              <span class="badge" style="background: #dc3545; color: white; padding: 6px 10px; border-radius: 6px;">
                                CC-00<?php echo $cuenta['id_cuenta_x_cobrar']; ?>
                              </span>
                            </td>
                            <td style="padding: 15px; vertical-align: middle; font-weight: 500; color: #333;">
                              <i class="fa fa-user me-1" style="color: #dc3545;"></i><?php echo $cuenta['tipo_id'] . '-' . $cuenta['id_cliente'] . ' ' . $cuenta['nombre_cliente'];?>
                            </td>
                            ...
                            <td style="padding: 15px; vertical-align: middle; text-align: center;">
                              <div class="btn-group" role="group">
                                <?php if($cuenta['saldo_pendiente'] > 0 && $cuenta['estado_cuenta'] != 'anulada'): ?>
                                <button
                                  onclick="ObtenerCuentaCobrar(<?php echo $cuenta['id_cuenta_x_cobrar']; ?>)"
...
<div class="modal fade" id="PagoModal" tabindex="-1" aria-labelledby="pagoModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content" style="border-radius: 12px; overflow: hidden; border: none;">
      <form id="formCobrarModificar" onsubmit="return validar_formulario()" method="post" action="index.php?url=cobrar&action=registrar_pago">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" id="clientePago" name="clientePago" placeholder="Cliente con deuda"readonly>
